...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://task_manager_db_wkik_user:rGm4EKEsr2lfbThN1vgGA0iShJ0goD3l@dpg-co41fuq1hbls73bo2fdg-a.oregon-postgres.render.com/task_manager_db_wkik',
        conn_max_age=600
    )
}
